...
export default function Blog() {
  ...
  return (
    <div className="prose dark:prose-invert mx-auto p-6">
      {/* ✅ Back to Home Button */}
      <Link href="/" className="inline-block mb-4 px-4 py-2 bg-blue-600 dark:bg-blue-400 text-white rounded-md hover:bg-blue-700 dark:hover:bg-blue-500 transition">
        ⬅️ Back to Home
      </Link>
